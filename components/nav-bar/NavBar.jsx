...
import CookieClient from "@/components/nav-bar/CookieClient";
  ...
  return (
    <div className="sticky top-0 bg-[#014164] z-50">
      <div>
        ...
        <div
          className="Mobile text-white flex h-20 items-center ml-5 justify-between md:hidden transition duration-200 z-50">
          <Link href={"/events"}>
            <Image src="/logoFE.webp" alt="" width={50} height={50}/>
          </Link>
